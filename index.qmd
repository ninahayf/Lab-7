...
-   **UHI.csv**: Urban heat island effect in 2023 for each city in the US [@Climate_Matters_2023]

-   **denver_neworleans.csv**: Specific data for Denver and New Orleans, including - EMINT (extreme minimum temp), EMAXT (Extreme maximum temp), TAVG (temp average), TMIN (temp minimum), TMAX (temp maximum). 
...
### Statistical Tests 
- **Multiple Linear Regression**: Modeled changes in temperature-related metrics over time, using elevation as a predictor
