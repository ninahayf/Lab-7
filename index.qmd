...
# Read hot days data
hot_days <- read_csv("cleaned_90_or_higher.csv.xlsx")
elevation_data <- read_csv("elevation_US_Cities.csv")

# Convert elevation column to numeric
colnames(elevation_data) <- c("City", "State", "Low_Feet", "High_Feet")
elevation_data <- elevation_data %>%
  mutate(Elevation = as.numeric(High_Feet)) %>%
